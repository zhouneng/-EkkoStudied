/**
 * 文件名: PromptStudioView.tsx
 * 功能: 提示词工作室的主视图组件 (显示在右侧面板)。
 * 核心逻辑:
 * 1. 提供提示词编辑 (Textarea)、参考图管理和版本控制功能。
 * 2. 集成快捷标签 (@原图, @生成图) 和生成参数配置。
 * 3. 处理文件拖拽以添加参考图。
 * 4. 显示分析流水线进度覆盖层。
 */
